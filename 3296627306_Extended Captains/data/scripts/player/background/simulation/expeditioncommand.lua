...
local ecnc_ExpeditionCommand_getAreaSize_original = ExpeditionCommand.getAreaSize

-- Override the function
function ExpeditionCommand:getAreaSize(ownerIndex, shipName)
    local pos = {x = 0, y = 0}
    
    if ecnc_ExpeditionCommand_getAreaSize_original then
        pos = ecnc_ExpeditionCommand_getAreaSize_original(self,ownerIndex, shipName)
    end
