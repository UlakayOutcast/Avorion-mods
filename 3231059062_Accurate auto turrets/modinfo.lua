...
meta =
{
    ...
    name = "accurateautoturrets",

    -- Title of your mod that will be displayed to players
    title = "Accurate auto turrets",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Makes computer controlled turret on player owned ships more accurate by accounting for both target velocity and own ship velocity. ",
