...
meta =
{
    ...
    name = "QoLPatrolCollect",

    -- Title of your mod that will be displayed to players
    title = "Pes Anserinus Patrol QoL",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod makes ships that are on patrol collect dropped items when there are no enemies in the sector.",

    -- Insert all authors into this list
    authors = {"PesAnserinus"},
