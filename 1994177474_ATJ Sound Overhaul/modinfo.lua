...
meta =
{
    ...
    name = "ATJ Sound Overhaul",

    -- Title of your mod that will be displayed to players
    title = "ATJ Sound Overhaul",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Sound effects in Avorion are replaced with more heavy sci fi sounds this mod is part of the Avorion The Jorney Collection. Sounds come from Pond5 and 2 were ripped from Fallout 4 including the railgun and launcher sounds.",

    -- Insert all authors into this list
    authors = {"Black_Disciple"},
    ...
    contact = "BlackDisciple1997@gmail.com",
}
