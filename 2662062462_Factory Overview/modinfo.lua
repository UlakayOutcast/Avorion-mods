...
meta =
{
    ...
    description = "The mod adds an extra tab to the Player window to show the profit values for the player factories. Supports Alliance factory view.",
