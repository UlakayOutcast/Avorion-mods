...
meta =
{
    ...
    name = "FleetShipStatus",

    -- Title of your mod that will be displayed to players
    title = "Fleet Ship Status UI",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod allows you to select ships and stations to see their status in real time. Use the settings menu (hold shift -> click 'FSS' button in top right) to select ships/stations whose HP/shields you want to see at all times and click 'enable'. You can also set the opacity and move the HUD overlay. Your current ship is omitted from the list even if it's selected, in order to reduce clutter.",
