...
meta =
{
    ...
    name = "[2.0] - (SDK) Rebalance - Ship & Station Boarding",

    -- Title of your mod that will be displayed to players
    title = "[2.0] - (SDK) Rebalance - Ship & Station Boarding",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This Mod allows a chance for boarded stations to be funtional.",
