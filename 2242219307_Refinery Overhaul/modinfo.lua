...
meta =
{
    ...
    name = "RefineryOverhaul",

    -- Title of your mod that will be displayed to players
    title = "Refinery Overhaul",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Alters refinery speeds. Now refineries work like this: NPCs have production capacity set at 10,000. Players have same capacity as they build (it's pulled from stats) or 10k if they have less than 10k. Refineries need 2/3/4/5/6/7/8 (For Iron / Titanium / Naonite / Trinium / Xanion / Ogonite / Avorion ore) work per unit of ore per second. Scrap is 2.5x cheaper in terms of work units (thus faster).",
    ...
    contact = "administrator@michalpol.pl",
}
