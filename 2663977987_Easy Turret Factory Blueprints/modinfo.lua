...
meta =
{
    ...
    name = "EasyTurretFactoryBlueprints",

    -- Title of your mod that will be displayed to players
    title = "Easy Turret Factory Blueprints",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Mod allowing direct creation of turret blueprints.",
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "2.3", max = "999.3.1"}
    },
