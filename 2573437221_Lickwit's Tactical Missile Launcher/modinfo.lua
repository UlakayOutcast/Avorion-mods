...
meta =
{
    ...
    title = "Tactical Missile Launcher",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod adds a new type of weapon to the game, the Tactical Missile Launcher. It's a Missile launcher with highly increased range, size, explosion radius and projectile size. To balance this out the projectiles are a bit harder to aim and the reload is quite significant. ",
    ...
    contact = "lickwit.business@gmail.com",
}
