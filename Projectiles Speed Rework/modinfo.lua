...
meta =
{
    ...
    name = "Projectiles Speed Rework",

    -- Title of your mod that will be displayed to players
    title = "Переработка скорости снарядов",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Этот мод был призван решить большую проблему: скорость снаряда в базовой игре настолько высока, что это не похоже на большую битву с кучей звездолетов в темноте. Этот мод должен исправить это, пытаясь сохранить баланс базовой игры за счет уменьшения базовой скорости (X2) снаряда без ущерба для DPS. А так же увеличивает скорость башен.",

    -- Insert all authors into this list
    authors = {"DNADigital. изменено by Ulukay"},
