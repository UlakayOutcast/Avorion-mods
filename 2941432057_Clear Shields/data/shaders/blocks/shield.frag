...
void main() 
{
    ...
    // Affects the distortion effect colour? where the ship appears to phase to the sides slightly, to only 10% of normal
	// this effectively makes the effect almost invisible
    vec2 separation = separation * 0.1;
	...
	//Leaving this at 0.02 (2%) makes the shield *just* visible even with the white colour
	outFragColor.rgb += 0.02;
#endif
}
