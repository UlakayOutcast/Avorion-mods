...
meta =
{
    ...
    name = "Maximum Speed Normalization",

    -- Title of your mod that will be displayed to players
    title = "Нормализация максимальной скорости",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Попытка убрать разницу в максимальной скорости между малыми и большими кораблями. Также увеличивает предел максимальной скорости. | An attempt to remove the difference in maximum speed between small and large ships. Also increases the maximum speed limit.",
