...
meta =
{
    ...
    name = "EmergencyWeapon",

    -- Title of your mod that will be displayed to players
    title = "Legion Emergency Weapon System",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "The Emergency Weapon System is a special weapon that goes into a civil turret slot! Its main use is to fill up unused civil slots, but to also function as a special weapon. Its cooldown is very high which is why its for emergencies only. When activated, it will fire a quick burst of projectiles that seek hostile targets.",
