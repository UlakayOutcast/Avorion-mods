...
meta =
{
    ...
    name = "ContextualAutopilotHotkey",

    -- Title of your mod that will be displayed to players
    title = "Autopilot Hotkey for Targets",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This adds a new hotkey that will start a target-appropriate autopilot action just like you'd get in strategy mode by selecting the ship and right-clicking on the target.\n\n- Asteroids get mined\n- Wreckages get salvaged\n- Enemies get attacked\n- Stations get docked to\n- Friendly ships get escorted\n- Wormholes and gates get flown through\n- No target toggles autopilot off\n\n(NEW!) this mod now has optional integration with Bubbet's very cool CustomHotkeys mod: https://steamcommunity.com/sharedfiles/filedetails/?id=2419941980\nIf you have CustomHotkeys enabled, this new autopilot hotkey will automatically appear as a rebindable custom hotkey in your player menu.\n\nIf you don't have CustomHotkeys, the mod will use backtick (`, above tab) as the hard-coded key to press. This can be changed by modifying the scancode value of '53' found in the contextualautopilothotkey.lua file.\n updated dependancy to work with current version of avorion, origonal author: Nyrin",
