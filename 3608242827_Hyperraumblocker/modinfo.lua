...
meta =
{
    ...
    title = "Hyperraumblocker System",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Fügt das fest einzubauende Hyperraumblocker-Modul hinzu. Installiert das Modul auf einem Schiff, um eine Sprung-Unterdrückungsblase zu erzeugen, die Spieler- und Allianz-Schiffe innerhalb einer seltenheitsabhängigen Reichweite vom Hypersprung abhält. Über das Debug-Skript `lib/entitydbg.lua` kann das Modul direkt gespawnt werden.\n    ",

    -- Insert all authors into this list
    authors = {"Starian - DigitalAlphaWorld.de"},
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "2.0", max = "2.5.11", optional = true}
    },
