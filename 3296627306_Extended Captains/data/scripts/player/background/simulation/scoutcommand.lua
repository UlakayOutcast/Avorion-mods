...
local ecnc_ScoutCommand_getAreaSize_original = ScoutCommand.getAreaSize

-- Override the function
function ScoutCommand:getAreaSize(ownerIndex, shipName)
    local pos = {x = 0, y = 0}
    
    if ecnc_ScoutCommand_getAreaSize_original then
        pos = ecnc_ScoutCommand_getAreaSize_original(self,ownerIndex, shipName)
    end
