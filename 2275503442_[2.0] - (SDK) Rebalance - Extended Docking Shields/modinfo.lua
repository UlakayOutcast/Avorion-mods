...
meta =
{
    ...
    name = "[2.5] - (SDK) Rebalance - Extended Docking Shields",

    -- Title of your mod that will be displayed to players
    title = "[2.5] - (SDK) Rebalance - Extended Docking Shields",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This Mod extends the shields of the Mothership to docked ships that have shields protecting them from all damage.",
