...
meta =
{
    ...
    name = "extended_captains",

    -- Title of your mod that will be displayed to players
    title = "Extended Captains",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A mod for additional captain classes and perks. 6 new captains, 24 new perks (12 positive, 12 negative).",
