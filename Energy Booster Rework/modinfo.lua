...
meta =
{
    ...
    name = "Energy Booster Rework",

    -- Title of your mod that will be displayed to players
    title = "Переделка уселителя генератора",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Немного изменённый вариант уселителя генератора, что бы начиная с распространённого были оба бонуса. Плюс немного увеличена мощьность.",
