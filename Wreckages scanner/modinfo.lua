...
meta =
{
    ...
    name = "Wreckages scanner",

    -- Title of your mod that will be displayed to players
    title = "Сканер обломков",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Добавляет модуль Сканер обломков и пользовательский интерфейс, который обнаруживает обломки в системе, а так же подсвечивает полезные системы в обломках.",

    -- Insert all authors into this list
    authors = {"Оригинальная идея Myrianne, Nyrin and MassCraxx, объеденино в единую систему и переведенно by Ulukay"},
