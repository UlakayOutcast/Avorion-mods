...
meta =
{
    ...
    name = "Thrusters unlocker",

    -- Title of your mod that will be displayed to players
    title = "Разблокировщик толкателей",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Подсистема для увеличения мощности толкателей и ориентации. Достаточно глючная, но рабочая.",

    -- Insert all authors into this list
    authors = {"Ulukay. Идея Beans."},
