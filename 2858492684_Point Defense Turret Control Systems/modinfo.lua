...
meta =
{
    ...
    name = "PointDefenseTurretControlSystems",

    -- Title of your mod that will be displayed to players
    title = "Point Defense Turret Control Systems",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds new defensive modules to further increase available weapon slots. Inspired by FuryoftheStars mod: Not Enough Turrets: Update",

    -- Insert all authors into this list
    authors = {"Janack42, The-Killer, FuryoftheStars"},
