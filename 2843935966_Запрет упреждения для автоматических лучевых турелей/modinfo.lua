...
meta =
{
    ...
    name = "NoAimPredictionForBeamWeapons",

    -- Title of your mod that will be displayed to players
    title = "No Aim Prediction For Beam Weapons",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Fix aim prediction on moving targets for automatic beam turrets, so they will not try to shoot ahead of target, like projectile weapon.",
