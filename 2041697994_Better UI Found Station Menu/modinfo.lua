...
meta =
{
    ...
    name = "BetterUIFoundStationMenu",

    -- Title of your mod that will be displayed to players
    title = "Better UI Found Station Menu",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod improve the Found Station Menu in two ways : -Sorting buildable stations alphabetically, -Adding a filtering text box.",
