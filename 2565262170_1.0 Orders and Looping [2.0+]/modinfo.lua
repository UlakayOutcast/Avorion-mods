...
meta =
{
    ...
    name = "1.0 Orders and Looping",

    -- Title of your mod that will be displayed to players
    title = "1.0 Orders and Looping",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Restores map orders and looping in Avorion 2.0",

    -- Insert all authors into this list
    authors = {"ItalianMafiaGuy"},
    ...
    -- },
    dependencies = {
        {id = "1722652757", min = "1.5.1", optional = true},
        {id = "Avorion", exact = "2.*"}
    },
