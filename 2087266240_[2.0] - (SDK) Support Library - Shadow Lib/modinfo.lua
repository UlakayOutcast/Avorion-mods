...
meta =
{
    ...
    title = "Shadow Lib (SDK)",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This is a collection of custom Libraries that I use to support other mods I make. You don't need to download this unless it is marked as requried by another mod.",
