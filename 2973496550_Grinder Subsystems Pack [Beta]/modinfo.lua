...
meta =
{
    ...
    title = "Grinder Subsystems Pack",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds four new Subsystems based on ramming and health\nCurrently in beta, things may be unbalanced and/or buggy\nCredits to game-icons.net for the icons",

    -- Insert all authors into this list
    authors = {"Macawesome75"},
    ...
    contact = "Macawesome75#9503 on Discord",
}
