...
meta =
{
    ...
    name = "BuiltFightersWithShields",

    -- Title of your mod that will be displayed to players
    title = "Built Fighters have Shields",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod allows fighters that come from fighter factories to have sheilds. Anything above Naonite can have shields, shield power increasing with turret rarity and material type, up to hte same amount of hull HP",
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "2.3.1", max = "2.5.99"}
    },
