...
meta =
{
    ...
    name = "[2.0] - (SDK) Rebalance - Realistic Block Physics",

    -- Title of your mod that will be displayed to players
    title = "[2.0] - (SDK) Rebalance - Realistic Block Physics",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This Mod set all block durability to the individual blocks. Normally a block needs to take as much damage as would be necessary to destroy all his children blocks before it itself is destroyed.Now when a block is destroyed all blocks not attached to the main block will break off this Ship or Station.",
    ...
    contact = "Please contact me via Discord with any questions or issues. I may be away or busy to please be patient. Please post any suggestions on the Steam Workshop item so others may take part in the suggestion. Discord User Name: Shadow Doctor K#2203",
}
