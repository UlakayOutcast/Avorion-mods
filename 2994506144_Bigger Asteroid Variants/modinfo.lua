...
meta =
{
    ...
    name = "Bigger_Asteroid_Variants",

    -- Title of your mod that will be displayed to players
    title = "Bigger Asteroid Variants",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This modification adds 3 more sector types to be generated. Those sectors contain different size type of asteroids, as normal or as a rare resource rich variant.",
