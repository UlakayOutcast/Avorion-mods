...
meta =
{
    ...
    title = "Consumers Plus",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Changes consumer stations to consume more than just one good each consumption cycle. Also randomizes the goods consumed and the percentage profit recieved from each good ranging from 7%-23%",

    -- Insert all authors into this list
    authors = {"DNADigital - Ideas guy and some coding", "Impyre - Basically the bulk of the coding lol he is baller"},
