...
meta =
{
    ...
    name = "Mining Priority for Mining Subsystem",

    -- Title of your mod that will be displayed to players
    title = "Приоритет добычи для субсистемы добычи.",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Объединили Mining Priority, GravyUI и UIElements Bubbet, изменили node.lua и изменили систему использования, чтобы Mining Priority работал в версии 2.*.*, и перевели на русский язык.",

    -- Insert all authors into this list
    authors = {"Bubbet! обновлено Bain Train, переведено и отредактировано by Ulukay"},
