...
meta =
{
    ...
    name = "Founding Cost Changes",

    -- Title of your mod that will be displayed to players
    title = "Изменения в стоимости основания",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Изменяет стоимость основания корабля, что бы требовались кредиты, а не ресурсы.",
