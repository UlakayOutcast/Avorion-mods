...
local ecnc_SalvageCommand_getAreaSize_original = SalvageCommand.getAreaSize

-- Override the function
function SalvageCommand:getAreaSize(ownerIndex, shipName)
    local pos = {x = 0, y = 0}
    
    if ecnc_SalvageCommand_getAreaSize_original then
        pos = ecnc_SalvageCommand_getAreaSize_original(self,ownerIndex, shipName)
    end
