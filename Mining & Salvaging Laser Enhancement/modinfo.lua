...
meta =
{
    ...
    name = "Mining & SalvagingLaser Enhancement",

    -- Title of your mod that will be displayed to players
    title = "Усовершенствование рудного и утилизирующего лазера.",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Диапазон луча и масштабирование характеристик гражданского лазера.",
