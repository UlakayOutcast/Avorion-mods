...
meta =
{
    ...
    description = "Alters the shield visuals to be clearer and easier to see through, including removing the strange displacement effect, reducing the shimmer and giving it a neutral colour.",
    ...
    -- },
    dependencies = {
        {id = "2947145915", exact = "*.*", incompatible = true},
        {id = "Avorion", max = "2.*"}
    },
    ...
    contact = "Leave a comment if you have any issues or suggestions",
}
